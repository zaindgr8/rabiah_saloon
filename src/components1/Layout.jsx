    ...
    return (
        <>
            <Container className="Top-Header" fluid>
                <Row className="h-100 d-none d-lg-flex ">
                    <Col className="Top-Header-Content col-5 d-flex justify-content-start align-items-center">
                        ...
                        <CustomLink to='/team' onClick={ () => handleClick()}>TEAM</CustomLink>
                    </Col>
                    ...
                    <Col className="Top-Header-Content col-5 d-flex justify-content-end align-items-center">
                        <CustomLink to='/shop' onClick={ () => handleClick()}>GOODS</CustomLink>
                        <CustomLink to='/posts' onClick={ () => handleClick()}>NEWS</CustomLink>
            ...
            <Navbar collapseOnSelect expand="lg" variant="dark" sticky="top" className="Top-Header-nav d-lg-none d-block">
                <Container fluid>
                    <Navbar.Brand to="/" className="ms-4" style={{fontWeight: "500", fontSize: "20px"}}>RABIAH SALOON</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mt-1 d-flex text-center " style={{height: "100svh"}}>
                            ...
                            <CustomLink to='/service' onClick={ () => handleClick()}><Heart size={32} color={"white"} style={{marginTop :"-4px"}}/> SERVICES</CustomLink>
                            <CustomLink to='/team' onClick={ () => handleClick()}><UsersThree size={32} color={"white"} style={{marginTop :"-4px"}}/> TEAM</CustomLink>
                            <CustomLink to='/about' onClick={ () => handleClick()}><Info size={32} color={"white"} style={{marginTop :"-4px"}}/>ABOUT US</CustomLink>
                            <CustomLink to='/posts' onClick={ () => handleClick()}><InstagramLogo size={32} color={"white"} style={{marginTop :"-4px"}}/> NEWS</CustomLink>
                            <CustomLink to='/shop' onClick={ () => handleClick()}><ShoppingBag size={32} color={"white"} style={{marginTop :"-4px"}}/> GOODS</CustomLink>
